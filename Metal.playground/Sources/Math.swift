...
extension float4x4 {
    ...
    public init(rotationAbout axis: float3, by angleRadians: Float) {
    ...
    public init(perspectiveProjectionFov fovRadians: Float, aspectRatio aspect: Float, nearZ: Float, farZ: Float) {
